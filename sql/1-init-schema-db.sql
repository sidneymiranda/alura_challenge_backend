...
values ('sidney@gmail.com', '$2a$12$x9MCvcYcJR4eFRCWu/2Nf.G64DbOB8rxcwbLb19BUr1hW5FRf/k2S', 'admin');
insert into users (email, "password", username)
values ('user@gmail.com', '$2a$12$GuKSHVgF.5nhDGiPqtLl/uhWaCnMvXw/vAkmZRW7ditsfFAQCHIxS', 'user');
insert into users (email, "password", username)
values ('manager@gmail.com', '$2a$12$nGeWfh3ynveQ5GAHHJFo9Osk0kyDzcNyn0KMEwk3wijaVU6.sMTie', 'manager');
